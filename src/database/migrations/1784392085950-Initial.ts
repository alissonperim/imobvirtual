...
export class Initial1784392085950 implements MigrationInterface {
  name = 'Initial1784392085950'
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "properties" ("id" character varying(21) NOT NULL, "name" character varying NOT NULL, "description" character varying, "base_rent_amount" numeric(10,2) NOT NULL, "solar_energy_active" boolean NOT NULL DEFAULT false, "iptu_charge" boolean NOT NULL DEFAULT false, "status" "public"."properties_status_enum" NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, "created_by" character varying, "updated_by" character varying, "deleted_by" character varying, "owner_id" character varying(21) NOT NULL, "address_id" character varying(21), CONSTRAINT "REL_1467c863029590ab33d4104857" UNIQUE ("address_id"), CONSTRAINT "PK_2d83bfa0b9fcd45dee1785af44d" PRIMARY KEY ("id"))`,
    )
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "contracts" ("id" character varying(21) NOT NULL, "start_date" TIMESTAMP NOT NULL, "end_date" TIMESTAMP, "rent_amount" numeric(10,2) NOT NULL, "due_day" integer NOT NULL, "status" "public"."contracts_status_enum" NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, "owner_id" character varying(21) NOT NULL, "renter_id" character varying(21) NOT NULL, "property_id" character varying(21) NOT NULL, CONSTRAINT "PK_2c7b8f3a7b1acdd49497d83d0fb" PRIMARY KEY ("id"))`,
    )
    await queryRunner.query(
      `CREATE TYPE "public"."renters_marital_status_enum" AS ENUM('MARIED', 'SINGLE', 'DIVORCED', 'WIDOWER')`,
    )
    await queryRunner.query(
      `CREATE TABLE "renters" ("id" character varying(21) NOT NULL, "name" character varying NOT NULL, "document" character varying NOT NULL, "phone_number" character varying NOT NULL, "email" character varying, "marital_status" "public"."renters_marital_status_enum" NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, "created_by" character varying, "updated_by" character varying, "deleted_by" character varying, "account_id" character varying(21), "address_id" character varying(21) NOT NULL, CONSTRAINT "UQ_c5e233aeb91b7bee0c36c31eb0f" UNIQUE ("document"), CONSTRAINT "REL_d5e984b1a14335c33939940ed2" UNIQUE ("account_id"), CONSTRAINT "REL_9671680a49163337756025deea" UNIQUE ("address_id"), CONSTRAINT "PK_6227c974d2f3c7ce77f208147ca" PRIMARY KEY ("id"))`,
    )
    await queryRunner.query(
      `CREATE TABLE "addresses" ("id" character varying(21) NOT NULL, "street" character varying NOT NULL, "neighborhood" character varying NOT NULL, "postal_code" character varying NOT NULL, "complement" character varying NOT NULL, "city" character varying NOT NULL, "state" character varying NOT NULL, "number" character varying NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, "created_by" character varying, "updated_by" character varying, "deleted_by" character varying, CONSTRAINT "PK_745d8f43d3af10ab8247465e450" PRIMARY KEY ("id"))`,
    )
    await queryRunner.query(
      `CREATE TYPE "public"."owners_marital_status_enum" AS ENUM('MARIED', 'SINGLE', 'DIVORCED', 'WIDOWER')`,
    )
    await queryRunner.query(
      `CREATE TABLE "owners" ("id" character varying(21) NOT NULL, "name" character varying NOT NULL, "document" character varying NOT NULL, "phone_number" character varying NOT NULL, "email" character varying, "marital_status" "public"."owners_marital_status_enum" NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, "created_by" character varying, "updated_by" character varying, "deleted_by" character varying, "account_id" character varying(21) NOT NULL, "address_id" character varying(21) NOT NULL, CONSTRAINT "UQ_dce1d2a570c1d8eb7db6e01f374" UNIQUE ("document"), CONSTRAINT "REL_b2e0d933f5d82d13aae5380d9a" UNIQUE ("account_id"), CONSTRAINT "REL_78a3211ef8814eb7f6258429ec" UNIQUE ("address_id"), CONSTRAINT "PK_42838282f2e6b216301a70b02d6" PRIMARY KEY ("id"))`,
    )
    await queryRunner.query(
      `CREATE TABLE "sessions" ("id" character varying(21) NOT NULL, "token_hash" character varying NOT NULL, "user_agent" character varying, "ip_address" character varying, "last_logged_at" TIMESTAMP, "device_id" character varying, "expires_at" TIMESTAMP NOT NULL, "revoked_at" TIMESTAMP, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, "account_id" character varying(21) NOT NULL, CONSTRAINT "UQ_abaa9e068cdd390bc5210f79884" UNIQUE ("token_hash"), CONSTRAINT "PK_3238ef96f18b355b671619111bc" PRIMARY KEY ("id"))`,
    )
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "otp_challenges" ("id" character varying(21) NOT NULL, "destination" character varying NOT NULL, "purpose" "public"."otp_challenges_purpose_enum" NOT NULL, "channel" "public"."otp_challenges_channel_enum" NOT NULL, "code_hash" character varying NOT NULL, "expires_at" TIMESTAMP NOT NULL, "attempts" integer NOT NULL DEFAULT '0', "consumed_at" TIMESTAMP, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, "created_by" character varying, "updated_by" character varying, "deleted_by" character varying, "account_id" character varying(21), CONSTRAINT "PK_c34f21df6c8aa51229715452068" PRIMARY KEY ("id"))`,
    )
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "accounts" ("id" character varying(21) NOT NULL, "phone_number" character varying NOT NULL, "role" "public"."accounts_role_enum" NOT NULL, "status" "public"."accounts_status_enum" NOT NULL, "last_login_at" TIMESTAMP, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, "created_by" character varying, "updated_by" character varying, "deleted_by" character varying, CONSTRAINT "UQ_31719ad17bc34678f49decea7de" UNIQUE ("phone_number"), CONSTRAINT "PK_5a7a02c20412299d198e097a8fe" PRIMARY KEY ("id"))`,
    )
    await queryRunner.query(
